...
export default function ClientForm() {
    ...
    return (
        <div className="max-w-6xl mx-auto mt-10 p-8 bg-gray-900/80 rounded-3xl shadow-2xl text-white">
            <h1 className="text-3xl font-bold text-center mb-8 text-blue-400 uppercase">Crear Crónica Nueva</h1>
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="grid grid-cols-2 gap-6">
                    <div>
                        ...
                        <input placeholder="Texto alternativo imagen" name="altKeyEus" value={formData.altKeyEus} onChange={handleChange} className={inputClass} />
                    ...
                    <div>
                        ...
                        <input placeholder="Texto alternativo imagen" name="altKey" value={formData.altKey} onChange={handleChange} className={inputClass} />
                ...
                <div>
                    ...
                    {links.map((link, i) => (
                        <div
                            key={i}
                            className="grid grid-cols-2 md:grid-cols-[auto_auto_min-content] gap-4 items-center"
                        >
                            <input
                            ...
                            <button
                                ...
                                className="w-10 h-10 flex items-center justify-center bg-red-600 hover:bg-red-700 text-white rounded-lg text-2xl font-semibold transition mb-4"
