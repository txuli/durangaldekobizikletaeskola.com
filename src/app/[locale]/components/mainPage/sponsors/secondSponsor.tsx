...
const SecondSponsor = (props: { Link: string | undefined; img: string | undefined; style: string | undefined }) => {
  return (
      <div className={`mx-auto flex justify-center items-center bg-customDarkBlue h-16 w-24  md:h-24 md:w-full rounded-lg shadow-lg transition duration-300 transform hover:scale-105 hover:shadow-xl ${props.style ?? ''}`}>
