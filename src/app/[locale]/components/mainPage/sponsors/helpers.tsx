...
const Helpers = (props: { Link: string | undefined; img: string | undefined; style: string | undefined}) => {
    return (
        <div className=" bg-transparent shadow-none lg:bg-custom-dark-blue lg:shadow-lg h-20 sm:h-24 w-18 md:w-full  rounded-lg   flex items-center justify-center mb-3 xl:mb-0">
    <a
        href={props.Link}
