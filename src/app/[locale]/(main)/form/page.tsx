        ...
        <section className=" mb-20">
            ...
            <form onSubmit={handleSubmit} className="mt-10 max-w-3xl mx-auto bg-gradient-to-br bg-customblue shadow-2xl rounded-lg p-8 text-black">
                <div className="grid gap-6 md:grid-cols-2">
                    <div>
                        <label className="block text-lg font-medium text-white">Izen abizena</label>
                        <input
                    ...
                    <div>
                        <label className="block text-lg font-medium text-white">Jaiotze data</label>
                        <input
                ...
                <div className="mt-6">
                    <label className="block text-lg font-medium text-white">Helbidea</label>
                    <input
                        className="border-2 border-gray-300 rounded-lg p-3 w-full focus:outline-none focus:ring-2 focus:ring-blue-500"
                        type="text"
                        name="address"
                ...
                <div className="grid gap-6 mt-6 md:grid-cols-2">
                    <div>
                        <label className="block text-lg font-medium text-white">Herria</label>
                        <input
                            className="border-2 border-gray-300 rounded-lg p-3 w-full focus:outline-none focus:ring-2 focus:ring-blue-500"
                            type="text"
                            name="city"
                    ...
                    <div>
                        <label className="block text-lg font-medium text-white">Ikasketa Zentroa</label>
                        <input
                            className="border-2 border-gray-300 rounded-lg p-3 w-full focus:outline-none focus:ring-2 focus:ring-blue-500"
                            type="text"
                            name="school"
                ...
                <div className="grid gap-6 mt-6 md:grid-cols-2">
                    <div>
                        <label className="block text-lg font-medium text-white">Aita Ama edo tutorearen Izen-abizenak</label>
                        <input
                            className="border-2 border-gray-300 rounded-lg p-3 w-full focus:outline-none focus:ring-2 focus:ring-blue-500"
                            type="text"
                            name="guardianName"
                    ...
                    <div>
                        <label className="block text-lg font-medium text-white">Telefono Zenbakia</label>
                        <input
                            className="border-2 border-gray-300 rounded-lg p-3 w-full focus:outline-none focus:ring-2 focus:ring-blue-500"
                            type="tel"
                            name="phone"
                ...
                <div className="mt-6">
                    <label className="block text-lg font-medium text-white">Posta electronikoa</label>
                    <input
                        className="border-2 border-gray-300 rounded-lg p-3 w-full focus:outline-none focus:ring-2 focus:ring-blue-500"
                        type="email"
                        name="email"
                ...
                <div className="mt-6">
                    <label className="block text-lg font-medium text-white">Mezua</label>
                    <textarea
