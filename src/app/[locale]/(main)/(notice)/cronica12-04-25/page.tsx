...
export default function Page() {
    const t = useTranslations("cronica12-04-25Page");
    return (

        <>
            <TopImage image="https://photos.txuli.com/duranguesa/notices/cronica120425.jpg" alt={t("altImage")} title={t("title")} subTitle={t("subTitle")} />
