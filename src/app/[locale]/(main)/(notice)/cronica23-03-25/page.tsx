...
export default function Page() {
    const t = useTranslations("cronica23-03-25Page");
    return (

        <>
            <TopImage image="https://photos.txuli.com/duranguesa/notices/cronica4c.jpg" alt={t("altImage")} title={t("title")} subTitle={t("subTitle")} />
            ...
            <SubTitle subTitle={t("subTitle2")} />
                  ...
                  <div className="mb-10 text-center">
                   <a href="https://www.gtxe.eus/datos/carreras/202503221158130.XXXIII%20AMAIKAK%20BAT%20TXIRRINDULARIEN%20PROBA,%20clasificacion.pdf?s_CAT=CAD&s_ANIO=2025" className="font-fredoka text-blue-500 underline font-semibold text-2xl" target="_blank" rel="noopener noreferrer">XXXIII AMAIKAK BAT TXIRRINDULARIEN PROBA</a>
                   </div>
                    <div className="mb-10 text-center">
