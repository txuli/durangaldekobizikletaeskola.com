...
const Sponsor = () => {
    ...
    const renderSecondarySponsors = () => (
        <>
            ...
            <div className=" grid w-10/12 mx-auto grid-cols-3 lg:grid-cols-4  place-items-center gap-4  justify-items-center mb-6">
    ...
    const renderHelpers = () => (
        <>
            ...
            <div className=" bg-customDarkBlue lg:bg-transparent  rounded-lg w-9/12 mx-auto grid grid-cols-5  lg:flex lg:space-x-4 sm:gap-8 justify-center mb-20 place-items-center ">
